...
function InitTransforms() {
	...
	sTransformText[0] = "Translate of +3 on the x axis, and -5 on the z axis";
	sTransform[0] = utils.MakeTranslateMatrix(3,0,-5);
	
	sTransformText[1] = "Rotate of 30 degrees on the y axis";
	sTransform[1] = utils.MakeRotateYMatrix(30);
	
	sTransformText[2] = "Make the starship 2 times bigger";
	sTransform[2] = utils.MakeScaleMatrix(2);
	
	sTransformText[3] = "Make the starship 1.5 times longer on the x axis, and half on the other axis";
	sTransform[3] = utils.MakeScaleNuMatrix(1.5, 0.5, 0.5);
	       
	sTransformText[4] = "Mirror over the yz plane";
	sTransform[4] = utils.MakeScaleNuMatrix(-1, 1, 1);
	       
	sTransformText[5] = "Flatten over the zx plane";
	sTransform[5] = utils.MakeScaleNuMatrix(1, 0, 1);
	       
	sTransformText[6] = "Make a shear along the x axis, with a factor of 1 along the y axis";
	sTransform[6] = utils.MakeShearXMatrix(1, 0);
