...
int main() {
    ...
    ShaderProgram shaderProgram(
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/transformations/transformations_ex2/shaders/vertex.vs",
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/transformations/transformations_ex2/shaders/fragment.fs"
    );
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glp::Mat4 t1 {
            glp::translate(0.5f, -0.5f, 0.0f).dot(glp::rotateZ(time * toDegrees()))
        };
        shaderProgram.setMat4("transform", t1);
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);

        // Top left container
        glp::Mat4 t2 {
            glp::translate(-0.5f, 0.5f, 0.0f).dot(glp::scale(std::sin(time), std::sin(time), std::sin(time)))
        };
        shaderProgram.setMat4("transform", t2);
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
