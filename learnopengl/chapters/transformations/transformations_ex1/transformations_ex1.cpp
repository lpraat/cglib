...
int main() {
    ...
    ShaderProgram shaderProgram(
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/transformations/transformations_ex1/shaders/vertex.vs",
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/transformations/transformations_ex1/shaders/fragment.fs"
    );
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glp::Mat4 t {
            glp::rotateZ(static_cast<float32>(glfwGetTime()*100)).dot(glp::translate(0.5f, -0.5f, 0.0f))
        };
