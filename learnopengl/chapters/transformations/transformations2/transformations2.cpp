...
int main() {
    ...
    ShaderProgram shaderProgram(
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/transformations/transformations2/shaders/vertex.vs",
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/transformations/transformations2/shaders/fragment.fs"
    );
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glp::Mat4 t {
            glp::translate(0.5f, -0.5f, 0.0f).dot(glp::rotateZ(static_cast<float32>(glfwGetTime()*100)))
        };
