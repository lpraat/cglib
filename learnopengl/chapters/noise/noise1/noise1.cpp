...
int main() {
    ...
    ShaderProgram shaderProgram(
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/noise/noise1/shaders/vertex.glsl",
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/noise/noise1/shaders/fragment.glsl"
    );
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        std::vector<float32> v = randomNoise<float32>(gridSize, true);
        vertices = v.data();
