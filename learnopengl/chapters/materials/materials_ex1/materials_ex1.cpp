...
int main()
{
    ...
    ShaderProgram lightingProgram(
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/materials/materials_ex1/shaders/lighting/vertex.glsl",
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/materials/materials_ex1/shaders/lighting/fragment.glsl"
    );

    ShaderProgram lampProgram(
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/materials/materials_ex1/shaders/lamp/vertex.glsl",
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/materials/materials_ex1/shaders/lamp/fragment.glsl"
    );
    ...
    lightingProgram.setVec3("material.ambient",  {0.021, 0.1745, 0.0215});
    lightingProgram.setVec3("material.diffuse",  {0.07568, 0.61424, 0.07568});
    lightingProgram.setVec3("material.specular", {0.633, 0.727811, 0.633});
    lightingProgram.setFloat("material.shininess", 32.0f);

    lightingProgram.setVec3("light.specular", {1.0f, 1.0f, 1.0f});
    lightingProgram.setVec3("light.ambient", {1.0f, 1.0f, 1.0f});
    lightingProgram.setVec3("light.diffuse", {1.0f, 1.0f, 1.0f});
