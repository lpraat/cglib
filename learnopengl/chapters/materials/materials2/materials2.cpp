...
int main()
{
    ...
    ShaderProgram lightingProgram(
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/materials/materials2/shaders/lighting/vertex.glsl",
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/materials/materials2/shaders/lighting/fragment.glsl"
    );

    ShaderProgram lampProgram(
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/materials/materials2/shaders/lamp/vertex.glsl",
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/materials/materials2/shaders/lamp/fragment.glsl"
    );
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glp::Vec3<float32> lightColor {0.0f, 0.0f, 0.0f};
        lightColor.x = sin(glfwGetTime() * 2.0f);
        lightColor.y = sin(glfwGetTime() * 0.7f);
        lightColor.z = sin(glfwGetTime() * 1.3f);

        glp::Vec3 diffuseColor = lightColor   * glp::Vec3 {0.5f, 0.5f, 0.5f}; // decrease the influence
        glp::Vec3 ambientColor = diffuseColor * glp::Vec3 {0.2f, 0.2f, 0.2f}; // low influence
