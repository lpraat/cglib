...
int main() {
    ...
    ShaderProgram shaderProgram(
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/coordinate_systems/coordinate_systems_ex1/shaders/vertex.vs",
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/coordinate_systems/coordinate_systems_ex1/shaders/fragment.fs"
    );
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // View matrix
        glp::Mat4 view {glp::translate(1.0f, 0.0f, -10.0f)};

        // Projection matrix
        // Since this rarely changes it is better to set it outside the main loop
        glp::Mat4 projection {glp::perspectiveProjection(20.0f, 0.1f, 100.0f, 16.0f / 9.0f)};
