...
int main()
{
    ...
    ShaderProgram lightingProgram(
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/light_casters/light_casters1/shaders/lighting/vertex.glsl",
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/light_casters/light_casters1/shaders/lighting/fragment.glsl"
    );

    ShaderProgram lampProgram(
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/light_casters/light_casters1/shaders/lamp/vertex.glsl",
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/light_casters/light_casters1/shaders/lamp/fragment.glsl"
    );
    ...
    glp::Vec3 lightDir {-0.2f, -1.0f, -0.3f}; // directional light
    lightingProgram.use();
    ...
    lightingProgram.setVec3("lightDir", lightDir);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Do not render the cube light since now we are simulating a directional light
        // // render light
        // lampProgram.use();
