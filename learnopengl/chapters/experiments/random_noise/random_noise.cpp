...
std::vector<T> createGrid(uint16 dim, bool greyScale = true) {
...
int main() {
    ...
    ShaderProgram shaderProgram(
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/experiments/random_noise/shaders/vertex.glsl",
        "/Users/lpraat/develop/computer_graphics/learnopengl/chapters/experiments/random_noise/shaders/fragment.glsl"
    );
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        std::vector<float32> v = createGrid<float32>(gridSize, true);
        vertices = v.data();
